"""
This file originates from the openpiv-python project:

https://github.com/alexlib/openpiv-python/blob/cython_safe_installation/openpiv/c_src/lib.pyx

and is licensed under GPL 3.0, a copy of which can be found here:

https://github.com/alexlib/openpiv-python/blob/cython_safe_installation/LICENSE.txt
